...
# Create project
create_project 8k5_Shell_proj ./8k5_Shell_proj -part xcku115-flva1517-2-e
...
set obj [get_projects 8k5_Shell_proj]
set_property "board_part" "" $obj
set_property "compxlib.activehdl_compiled_library_dir" "$proj_dir/8k5_Shell_proj.cache/compile_simlib/activehdl" $obj
set_property "compxlib.funcsim" "1" $obj
set_property "compxlib.ies_compiled_library_dir" "$proj_dir/8k5_Shell_proj.cache/compile_simlib/ies" $obj
set_property "compxlib.modelsim_compiled_library_dir" "$proj_dir/8k5_Shell_proj.cache/compile_simlib/modelsim" $obj
set_property "compxlib.overwrite_libs" "0" $obj
set_property "compxlib.questa_compiled_library_dir" "$proj_dir/8k5_Shell_proj.cache/compile_simlib/questa" $obj
set_property "compxlib.riviera_compiled_library_dir" "$proj_dir/8k5_Shell_proj.cache/compile_simlib/riviera" $obj
set_property "compxlib.timesim" "1" $obj
set_property "compxlib.vcs_compiled_library_dir" "$proj_dir/8k5_Shell_proj.cache/compile_simlib/vcs" $obj
...
set obj [get_filesets sources_1]
set files [list \
 "[file normalize "$origin_dir/srcs/design_1.bd"]"\
 "[file normalize "$origin_dir/srcs/design_1_wrapper.v"]"\
 "[file normalize "$origin_dir/constraints/custom_parts_2133.csv"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/srcs/design_1.bd"
...
set file "$origin_dir/srcs/design_1_wrapper.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
# set file "$origin_dir/../project_7_1/8k5_Shell_proj/custom_parts_2133.csv"
# set file [file normalize $file]
# set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
# set_property "file_type" "CSV" $file_obj
# set_property "is_enabled" "1" $file_obj
# set_property "is_global_include" "0" $file_obj
# set_property "library" "xil_defaultlib" $file_obj
# set_property "path_mode" "RelativeFirst" $file_obj
...
set file "[file normalize "$origin_dir/constraints/ad_8k5.xdc"]"
set file_imported [import_files -fileset constrs_1 $file]
set file "constraints/ad_8k5.xdc"
...
set file_imported [import_files -fileset constrs_1 $file]
set file "constraints/bitstream.xdc"
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property "file_type" "XDC" $file_obj
set_property "is_enabled" "1" $file_obj
set_property "is_global_include" "0" $file_obj
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/constraints/ddr4_test.xdc"]"
set file_imported [import_files -fileset constrs_1 $file]
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/constraints/ddr4_test_axi4.xdc"]"
set file_imported [import_files -fileset constrs_1 $file]
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/constraints/ddr4sdram_b0_lane8.xdc"]"
set file_imported [import_files -fileset constrs_1 $file]
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/constraints/ddr4sdram_b0_unused.xdc"]"
set file_imported [import_files -fileset constrs_1 $file]
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/constraints/ddr4sdram_b1_lane8.xdc"]"
set file_imported [import_files -fileset constrs_1 $file]
set file "constraints/ddr4sdram_b1_lane8.xdc"
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property "file_type" "XDC" $file_obj
set_property "is_enabled" "1" $file_obj
set_property "is_global_include" "0" $file_obj
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/constraints/ddr4sdram_b1_unused.xdc"]"
set file_imported [import_files -fileset constrs_1 $file]
set file "constraints/ddr4sdram_b1_unused.xdc"
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property "file_type" "XDC" $file_obj
set_property "is_enabled" "1" $file_obj
set_property "is_global_include" "0" $file_obj
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/constraints/ddr4sdram_locs_b0_twin_die.xdc"]"
set file_imported [import_files -fileset constrs_1 $file]
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/constraints/ddr4sdram_locs_b0_x64.xdc"]"
set file_imported [import_files -fileset constrs_1 $file]
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/constraints/ddr4sdram_locs_b0_x72.xdc"]"
set file_imported [import_files -fileset constrs_1 $file]
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/constraints/ddr4sdram_locs_b1_twin_die.xdc"]"
set file_imported [import_files -fileset constrs_1 $file]
set file "constraints/ddr4sdram_locs_b1_twin_die.xdc"
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property "file_type" "XDC" $file_obj
set_property "is_enabled" "1" $file_obj
set_property "is_global_include" "0" $file_obj
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/constraints/ddr4sdram_locs_b1_x64.xdc"]"
set file_imported [import_files -fileset constrs_1 $file]
set file "constraints/ddr4sdram_locs_b1_x64.xdc"
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property "file_type" "XDC" $file_obj
set_property "is_enabled" "1" $file_obj
set_property "is_global_include" "0" $file_obj
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/constraints/ddr4sdram_locs_b1_x72.xdc"]"
set file_imported [import_files -fileset constrs_1 $file]
set file "constraints/ddr4sdram_locs_b1_x72.xdc"
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property "file_type" "XDC" $file_obj
set_property "is_enabled" "1" $file_obj
set_property "is_global_include" "0" $file_obj
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/constraints/ddr4sdram_props_b0_twin_die.xdc"]"
set file_imported [import_files -fileset constrs_1 $file]
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/constraints/ddr4sdram_props_b1_twin_die.xdc"]"
set file_imported [import_files -fileset constrs_1 $file]
set file "constraints/ddr4sdram_props_b1_twin_die.xdc"
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property "file_type" "XDC" $file_obj
set_property "is_enabled" "1" $file_obj
set_property "is_global_include" "0" $file_obj
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/constraints/refclk200.xdc"]"
set file_imported [import_files -fileset constrs_1 $file]
set file "constraints/refclk200.xdc"
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property "file_type" "XDC" $file_obj
set_property "is_enabled" "1" $file_obj
set_property "is_global_include" "0" $file_obj
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/constraints/user_sw.xdc"]"
set file_imported [import_files -fileset constrs_1 $file]
set file "constraints/user_sw.xdc"
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property "file_type" "XDC" $file_obj
set_property "is_enabled" "1" $file_obj
set_property "is_global_include" "0" $file_obj
...
puts "INFO: Project created:8k5_Shell_proj"
